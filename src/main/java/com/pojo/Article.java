...
public class Article implements Serializable {
	...
	private static final long serialVersionUID = -2389391342236644498L;
	...
	public String toString() {
		return "Article [id=" + id + ", title=" + title + ", content=" + content + ", picture=" + picture
				...
				+ updated + ", commentCnt=" + commentCnt + ", articleType=" + articleType + ", terms=" + terms + ", user="
				+ user + ", channel=" + channel + ", cat=" + cat + "]";
	}
