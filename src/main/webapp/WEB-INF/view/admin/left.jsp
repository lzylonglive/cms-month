...
<ul class="sidebar navbar-nav" >
	...
	<li class="nav-item"><a class="nav-link"  href="javascript:void(0)" data="/admin/userlist">
	...
	<li class="nav-item"><a class="nav-link" href="javascript:void(0)" data="/links/friendLink">
