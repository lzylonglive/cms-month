...
<div class="container">
	...
	<script type="text/javascript">
	   ...
	   function addArticle(){
		   ...
		   $.post("/special/addArticle",{specialId:${special.id},articleId:$("#articleId").val()},function(msg){
				if(msg.result==1){
					alert("处理成功")
		...
		function remove(specialId,articleId){
			...
			$.post("/special/removeArticle",{specialId:specialId,articleId:articleId},function(msg){
				if(msg.result==1){
					alert("处理成功")
